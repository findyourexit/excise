...
pub struct Theme {
    ...
    pub state_attention: Color,
    pub state_rebuilding: Color,
...
impl Theme {
    ...
    pub const fn for_id(id: ThemeId) -> Self {
        match id {
            ...
            ThemeId::Monochrome => Self {
                ...
                state_attention: Color::Reset,
                state_rebuilding: Color::Reset,
    ...
    pub const fn map_color(self, index: usize) -> Color {
        match index % 8 {
            0 => self.focus,
            1 => self.state_shared,
            2 => self.state_attention,
            3 => self.state_scanning,
            4 => self.state_rebuilding,
            5 => self.text_danger,
...
const fn dark(
    ...
    Theme {
        ...
        state_attention: warning,
        state_rebuilding: focus,
