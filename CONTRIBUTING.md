...
For a substantial change, open an issue before implementation. It lets contributors agree on the scope and public behavior before spending time on the change.
...
- Destructive-path changes must preserve identity checks, no-follow behavior, consent, repeat checks before deletion, and partial-failure reporting.
